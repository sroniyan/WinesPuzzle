...
package org.assignment.puzzle;
import java.io.*;
import java.util.*;

import org.assignment.config.Paths;

import com.almworks.sqlite4java.*;


public class WineTaste {
	static final String problemFilename = Paths.getInputDirectory()+"person_wine_3.txt"; /* Path to problem file */
	static final String resultFilename = Paths.getOutputDirectory()+"result4.txt"; /* Path to result file */
